// Package AZP003 defines an analyzer that reports data sources whose same-named resource
...
var Analyzer = &analysis.Analyzer{
	...
	URL:      "https://github.com/katbyte/azproviderlint/blob/main/checks/AZP/AZP003_data_source_missing_properties/README.md",
...
type collector struct {
	...
	ignored map[string]map[int]bool             // filename -> lines carrying //azignore:AZP003
}

// ignoredAt reports whether pos falls on (or directly below) an //azignore:AZP003 directive.
...
func run(pass *analysis.Pass) (any, error) {
	...
	c := &collector{pass: pass, decls: map[types.Object]*ast.FuncDecl{}, methods: map[string]map[string]*ast.FuncDecl{}, ignored: azignore.Lines(pass, "AZP003")}
