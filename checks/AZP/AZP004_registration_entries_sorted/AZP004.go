// Package AZP004 defines an analyzer that reports registration.go map and slice entries
...
var Analyzer = &analysis.Analyzer{
	...
	URL:  "https://github.com/katbyte/azproviderlint/blob/main/checks/AZP/AZP004_registration_entries_sorted/README.md",
	Run:  run,
}
...
// rewritten. Per-section reports keep `//azignore:AZP004` scoped to one section instead of
