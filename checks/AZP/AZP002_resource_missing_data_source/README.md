...
AZP002 reports a registered resource with no data source of the same Terraform type name in the service package.
...
Put `//azignore:AZP002 - <reason>` at the end of the line, or on the line above it. The reason is required.

```go
"azurerm_example": resourceExample(), //azignore:AZP002 - <reason>
```
